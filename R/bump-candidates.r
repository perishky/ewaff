...
#'
#' @export
ewaff.bump.candidates <- function(estimate, p.value, chr, pos, maxgap=500, p.cutoff=0.05, verbose=T) {
    ...
    if (verbose)
        message("Found ", nrow(candidates), " candidate bumps.")
