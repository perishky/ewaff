#' ewaff.bump.statistics
#'
#' Calculate statistics for a set of genomic regions.
#'
#' @param regions Data frame of genomic regions providing chromosome (chr), start and end coordinates.
...
#'
#' @export
ewaff.bump.statistics <- function(regions, estimate, se, methylation, chr, pos, verbose=T) {
    ...
    regions$z <- unlist(mclapply(members, function(idx) {
